...
public class failedjson {

    public static void main(String[] args) {
        failedjson json = new failedjson(data);
        json.get("did");
    }
    ...
    public String get(String id) {
        ...
        failedjson chae = new failedjson(jsondata);
